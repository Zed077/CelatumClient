...
<jsp:useBean id="sampleHelloProxyid" scope="session" class="com.celatum.service.HelloProxy" />
<%
...
case 10:
        gotMethod = true;
        com.celatum.service.Hello getHello10mtemp = sampleHelloProxyid.getHello();
