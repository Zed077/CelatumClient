...
public class HelloServiceLocator extends org.apache.axis.client.Service implements com.celatum.service.HelloService {
    ...
    private java.lang.String Hello_address = "http://localhost:8080/Celatum/services/Hello";
    ...
    public com.celatum.service.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.celatum.service.HelloSoapBindingStub _stub = new com.celatum.service.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.celatum.service.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                com.celatum.service.HelloSoapBindingStub _stub = new com.celatum.service.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.celatum.com", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.celatum.com", "Hello"));
        }
